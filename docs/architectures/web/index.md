...
consume la REST API de `api` y no tiene lógica de negocio propia.
...
- [Relevamiento UX](../../analysis/ux/web/index.md) — pantallas, microcopy, estados, tokens y gaps
- [Análisis del servicio](../../analysis/services/web.md) — insumo de consolidación
- [API que consume](../../apis/api.yaml) — OpenAPI de `api`
