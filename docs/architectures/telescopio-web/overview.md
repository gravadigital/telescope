...
etapas y los permisos viven en `telescopio-api`; el frontend consume la REST API y refleja
...
[`docs/analysis/ux/telescopio-web/`](../../analysis/ux/telescopio-web/index.md): bloques,
